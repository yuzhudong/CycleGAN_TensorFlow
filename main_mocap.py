...
class CycleGAN:
    ...
    def __init__(self, pool_size, lambda_a,
        ...
        self.fake_images_A = np.zeros(
            (self._pool_size, 1,model.IMG_WIDTH, model.IMG_HEIGHT,1 )
        )
    ...
    def save_images_original(self, sess, epoch):
        """
        Saves input and output images.
    ...
    def train_original(self):
        """Training Function."""
        # Load Dataset from the dataset folder
        self.inputs, iterator  = data_loader.load_data(
